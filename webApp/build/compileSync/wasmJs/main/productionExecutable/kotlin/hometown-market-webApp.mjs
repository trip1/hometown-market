...
import { importObject, setWasmExports } from './hometown-market-webApp.import-object.mjs'
...
const wasmFilePath = './hometown-market-webApp.wasm';
...
try {
  ...
  if (isBrowser) {
    wasmInstance = (await WebAssembly.instantiateStreaming(fetch(new URL('./hometown-market-webApp.wasm',import.meta.url).href), importObject, wasmOptions)).instance;
  }
} catch (e) {
